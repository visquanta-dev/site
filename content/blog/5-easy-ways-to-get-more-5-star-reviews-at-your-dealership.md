...
- Dealers running [VisQuanta's Reputation Management](https://www.visquanta.com/reputation-management) are answering inside the hour the review went live; dealers without a real response system are letting reviews sit for a week and paying the Map Pack penalty for it.
...
What actually moves the number at a dealership is a playbook built around the way car buyers decide. We pulled six weeks of review data from one of four dealers running [VisQuanta's Reputation Management](https://www.visquanta.com/reputation-management) - one of the specialist agents inside our AutoMaster Suite - to anchor the numbers. Here are the five tactics that actually work at a dealership, each tuned for the economics and timing of the showroom, not the salon.
...
The mechanism has to be automated because your BDC does not have the bandwidth to send 300 perfectly-timed manual texts a month. The [72-hour SMS request engine inside VisQuanta's Reputation Management](https://www.visquanta.com/reputation-management) fires at the emotional peak and routes the reply straight into the dealer's response queue. That 331-reviews-in-six-weeks number is not an accident of a friendly store; it is what happens when the request fires on time, every time, for every eligible customer in the DMS.
