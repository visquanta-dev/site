---
title: 53% of Dealer Leads Arrive After Hours. Nobody Answers.
slug: 53-dealer-leads-arrive-after-hours-nobody-answers
metaDescription: >-
...
Translate the volume into a per-store monthly number and the problem gets tangible. Our study found after-hours traffic averages 75 new leads per dealership per month. That is not 75 visits. That is 75 shoppers who submitted [contact](https://www.visquanta.com/book-demo) info and expected a response. For the 50-store sample, the monthly total is 3,743 after-hours leads sitting unanswered or getting a 9am reply to an 8pm question.
...
1. Export 30 days of inbound leads from your CRM, filtered to form fills and chat inquiries only
2. Tag each lead with the local timestamp it arrived
3. Flag every lead outside weekday 9am to 6pm as after-hours
4. Calculate the after-hours percentage and compare it against our 53% benchmark

Once you have the percentage, convert it to a per-month lead count. Our [platform](https://www.visquanta.com/auto-master-suite) data pegs the after-hours average at 75 new leads per dealership per month. If your store lands meaningfully above that figure, your exposure is higher than the sample. If you land below it, your daytime team is probably capturing demand that neighbors are missing. Either way, the number tells you how large the fix needs to be.
...
- [how AI transforms dealership jobs](https://www.visquanta.com/blog/ai-isnt-replacing-car-dealership-jobs-its-transforming-them)
