...
tags:
  ...
  - slug: dealership-finance
    title: Dealership Finance
...
entities:
  ...
  - name: Total cost of ownership
    sameAs: 'https://en.wikipedia.org/wiki/Total_cost_of_ownership'
hide_hero: true
---
...
- True total cost of ownership runs **3–5× the subscription fee** once you add integration, training, internal admin time, and manager oversight.
- Across 41 rooftops in our portal between February and April 2026, layered tools attributed **$1,892,160** in revenue — **$42,000 average per closed deal**, with **92%** of contacts being net-new (not warm CRM records).
...
Vendor success teams are paid to retain you. The metrics they highlight in a QBR are the metrics that make retention look easy — login frequency, messages delivered, tasks completed, features utilized. None of those answer the principal's actual question.
...
- **Login rate** measures compliance, not value. A system people are forced to use isn't necessarily one producing returns.
...
- **1,302 unique contacts** behind those events, of which **92% were first-time** — meaning these were not warm CRM records being re-touched, they were net-new pipeline
