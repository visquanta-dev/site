...
<script type="application/ld+json">
{
  ...
  "@type": "BlogPosting",
  "headline": "How to Move Aged Inventory Without Discounting",
  "description": "Aged inventory eats floorplan interest and pressures margin. The buyers for those units are already in your CRM. Here is the 5-step playbook VisQuanta dealers have used to recover $48M in revenue without cutting price.",
  "image": "https://www.visquanta.com/images/blog/how-to-move-aged-inventory-without-discounting/hero.webp",
  "datePublished": "2026-04-27",
  "dateModified": "2026-04-27",
  "author": {
    "@type": "Person",
    "name": "William Voyles",
    "url": "https://www.visquanta.com/author/william-voyles"
  },
  "publisher": {
    "@type": "Organization",
    "name": "VisQuanta",
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://www.visquanta.com/images/visquanta-logo.png"
    }
  },
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.visquanta.com/blog/how-to-move-aged-inventory-without-discounting"
  },
  "articleSection": "Inventory & Pricing"
}
</script>
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://www.visquanta.com/blog/category/inventory"
    },
    {
      "@type": "ListItem",
      "position": 4,
      "name": "How to Move Aged Inventory Without Discounting",
      "item": "https://www.visquanta.com/blog/how-to-move-aged-inventory-without-discounting"
    }
  ]
}
</script>
<script type="application/ld+json">
{
  ...
  "step": [
    ...
    },
    {
      "@type": "HowToStep",
      "position": 2,
      "name": "Match Buyer Profile to Unit",
      "text": "This is the step that separates a reactivation campaign from a generic newsletter blast. Each aged unit on your lot has a specific buyer profile — and a specific reason that profile has not yet bought."
    },
    {
      "@type": "HowToStep",
      "position": 3,
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How is this different from a normal lead nurture sequence?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Lead nurture sequences are aimed at active opportunities — contacts your team is already working. Reactivation is aimed at the much larger pool of contacts your team has already given up on. The sequencing, the messaging, and the segmentation are different because the starting assumption is different: a nurture lead is leaning in, a reactivation contact has gone cold and needs a specific reason to lean back."
      }
    },
    {
      "@type": "Question",
      "name": "Won't blasting old leads burn our SMS opt-in list?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes — if you blast. The playbook above is the opposite of a blast. Three touches, named sender, specific unit reference, soft close on touch three. The opt-out rate on this kind of sequence runs in the 1-2% range across our deployments, materially lower than most dealer email lists experience on a comparable send. Done badly, SMS reactivation will torch your list. Done with the structure above, it builds the list because customers reply."
      }
    },
    {
      "@type": "Question",
      "name": "What is a realistic close rate from a reactivation campaign?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For a properly segmented list (Steps 1 and 2 done well), expect 15-25% response, 4-8% appointments set, and 1.5-3% closed deals from the touched-contact universe. On a 1,500-contact campaign, that is 22-45 closed deals per cohort. Stores skipping the segmentation step typically see closed rates 60-70% lower because the messaging does not match the contact."
      }
    },
    {
      "@type": "Question",
      "name": "How long does it take to see the first deals close?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Dealers who deploy the playbook in week one start seeing appointment-set activity within 7-10 days and the first closed deals inside the first 30 days. Material aged-inventory movement — the kind that shows up on the floorplan report — starts in week 4-6. Reactivation is a compounding system, not a one-time event. The deals in month 3 are typically larger than the deals in month 1."
      }
    },
    {
      "@type": "Question",
      "name": "Do we need a dedicated reactivation rep, or can our existing BDC handle this?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The playbook can run through an existing BDC if you protect the BDC's time. The most common failure pattern is asking a BDC rep to handle reactivation outbound *and* live inbound calls at the same time — the live work always wins, the reactivation work always slips. The fix is either dedicated time blocks (mornings for reactivation, afternoons for live inbound) or moving the outbound layer onto an automated system that hands closing conversations to the BDC only when the contact is ready to talk."
      }
    }
  ]
}
...
# Every Aged Unit on Your Lot Has a Buyer in Your CRM
...
- [Why Every Dealership Needs AI for Lead Reactivation in 2026](https://www.visquanta.com/blog/why-every-dealership-needs-ai-for-lead-reactivation-in-2026)
- [7 CRM Strategies to Revive Dormant Leads](https://www.visquanta.com/blog/7-crm-strategies-to-revive-dormant-leads)
- [How AI Revives Dormant CRM Data](https://www.visquanta.com/blog/ai-revives-dormant-crm-data)
- [Speed to Lead: Why It Matters in Car Sales](https://www.visquanta.com/blog/speed-to-lead-why-it-matters-in-car-sales)
