...
export const integrations: Integration[] = [
    {
        ...
        description: 'Your CRM stays current without lifting a finger. Every conversation, every lead update, and every appointment is synced to VinSolutions in real-time. No double entry. No missed updates.',
        ...
        benefits: [
            ...
            { before: 'Manager asks \"did you call?\" with no record', after: 'Full activity log: 4 touches, appt set, confirmed via SMS' },
            { before: 'Data entry errors (wrong numbers)', after: 'AI logs exactly what was said, with no typos' },
