                ...
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="absolute top-[50%] left-0 -translate-y-1/2 w-[340px] bg-white border border-white/10 rounded-xl shadow-2xl overflow-hidden z-20 font-sans"
                        >
                            {/* Header */}
                            <div className="bg-white p-4 flex items-center justify-between border-b border-slate-100">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-slate-900 font-bold text-[15px]">Have a question?</div>
                                </div>
                            ...
                            <div className="p-5 space-y-4">
                                ...
                                <div className="flex gap-3">
                                    <div className="flex-shrink-0 w-8 h-8 rounded-full overflow-hidden border border-slate-100 mt-1">
                                        <img src="/images/nick.png" alt="Agent" className="w-full h-full object-cover" />
                                    </div>
                                    <div className="bg-slate-50 text-slate-700 text-sm p-3 rounded-lg rounded-tl-none border-l-2 border-[#FF7404] leading-relaxed shadow-sm">
                                ...
                                <div className="space-y-3 pt-2">
                                    <input
                                        type="text"
                                        placeholder="Name"
                                        className="w-full h-10 bg-white border border-slate-200 rounded-md px-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#FF7404] focus:ring-1 focus:ring-[#FF7404] transition-all"
                                    />
                                    ...
                                    <div className="relative">
                                        <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-1 border-r border-slate-200 pr-2 mr-2">
                                            ...
                                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-slate-400"><path d="m6 9 6 6 6-6" /></svg>
                                        </div>
                                        <input
                                            type="tel"
                                            placeholder="Phone"
                                            className="w-full h-10 bg-white border border-slate-200 rounded-md pl-16 px-3 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#FF7404] focus:ring-1 focus:ring-[#FF7404] transition-all"
                                        />
                                    </div>
                                    ...
                                    <textarea
                                        ...
                                        rows={3}
                                        className="w-full bg-white border border-slate-200 rounded-md px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#FF7404] focus:ring-1 focus:ring-[#FF7404] transition-all resize-none"
                                    />
                                </div>
                                ...
                                <div className="flex gap-2 items-start py-1">
                                    ...
                                    <p className="text-[10px] text-slate-500 leading-tight">
                                        By submitting you agree to receive SMS or e-mails. Rates may be applied.
                                    </p>
                                </div>

                                {/* Submit Button */}
                                <button className="w-full h-12 bg-[#18181b] hover:bg-black text-white rounded-lg flex items-center justify-center gap-2 transition-all shadow-lg shadow-black/10 hover:shadow-black/20 font-semibold transform active:scale-[0.98]">
                                    <span>Send</span>
                                ...
                                <div className="text-center pt-1">
                                    <span className="text-[10px] text-slate-400">Powered by <span className="text-[#FF7404] font-semibold">VisQuanta</span></span>
                                </div>
                            </div>
                        </motion.div>
