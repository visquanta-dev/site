...
const scenarios: Scenario[] = [
  {
    ...
    description: 'Your database is full of past shoppers who never pulled the trigger. We reengage them with natural SMS conversations that turn cold leads into booked appointments.',
    stats: [
      { value: '30%+', label: 'RESPONSE RATE' },
      { value: '340%', label: 'MORE CALLBACKS' },
    ],
    contactName: 'Thunder Road Powersports',
    contactRole: 'Reactivating: Sarah',
    avatarInitials: 'VQ',
    messages: [
      { id: 'msg1', sender: 'agent', content: "Hey Sarah, it's Thunder Road Powersports. You came in a couple weeks ago looking at the 2025 Can-Am Outlander. Just wanted to check — are you still thinking about it?" },
      { id: 'msg2', sender: 'user', content: "Hey! Yeah I've been meaning to come back, just got busy." },
      { id: 'msg3', sender: 'agent', content: "No worries at all! That Outlander is still here. We also just got a spring promo going — 0% financing for 36 months. Want to come in this Saturday?" },
      { id: 'msg4', sender: 'user', content: "Oh nice, yeah Saturday works. What time?" },
      { id: 'msg5', sender: 'agent', content: "How about 11am? I'll have Tyler set one aside for you and have everything ready when you get here." },
      { id: 'msg6', sender: 'user', content: "Perfect, see you then!" },
      { id: 'msg7', sender: 'agent', content: "Done! You're all set for Saturday at 11am. Looking forward to it." }
    ],
  ...
  },
  {
    ...
    number: '02',
    title: 'Speed to Lead',
    description: 'When a new lead lands from ATV Trader, Facebook, or your website, they get a personalized response in under 60 seconds — before they even finish browsing your competitor.',
    stats: [
      { value: '<60s', label: 'RESPONSE TIME' },
      { value: '24/7', label: 'COVERAGE' },
    ],
    contactName: 'Mike (Inbound Lead)',
    contactRole: '2025 Polaris RZR Pro R',
    avatarInitials: 'Mike',
    messages: [
      { id: 'tag1', sender: 'system', content: { title: 'LEAD SOURCE: ATV TRADER', subtitle: 'Arrived: Just now' }, type: 'source_tag' },
      { id: 'msg1', sender: 'agent', content: "Hey Mike, this is Thunder Road Powersports. I see you were checking out the 2025 Polaris RZR Pro R. Great choice — it's still available." },
      { id: 'msg2', sender: 'agent', content: "Would you like to come see it this weekend or schedule a quick call with our sales team?" },
      { id: 'msg3', sender: 'user', content: "Yeah, I'm interested. What's the best price you can do?" },
      { id: 'msg4', sender: 'agent', content: "I'd love to get you the best deal. Let me have Jake, our sales manager, give you a quick call — he can walk you through current pricing and any promotions." },
      { id: 'msg5', sender: 'user', content: "Tomorrow after 2pm works." },
      { id: 'msg6', sender: 'agent', content: "Done — Jake will call you tomorrow after 2pm. Looking forward to getting you into that RZR!" }
    ],
    link: "/speed-to-lead"
  },
  {
    ...
    description: 'Seasonal SMS campaigns built for powersports — spring kickoff promos, demo day invitations, end-of-season clearance. We write the copy, segment your list, and deliver.',
    stats: [
      { value: '22%', label: 'CONVERSION RATE' },
      { value: '98%', label: 'OPEN RATE' },
    ],
    contactName: 'Thunder Road Powersports',
    contactRole: 'Spring Campaign',
    avatarInitials: 'VQ',
    messages: [
      { id: 'tag1', sender: 'system', content: { title: 'SPRING PROMO CAMPAIGN' }, type: 'source_tag' },
      { id: 'msg1', sender: 'agent', content: "Hey Brandon, spring riding season is here! Thunder Road just got fresh inventory — new Yamaha MT-07s and Kawasaki Z900s just hit the floor." },
      { id: 'msg2', sender: 'agent', content: "We're running 0% APR for 48 months this month only. Interested in coming by for a test ride?" },
      { id: 'msg3', sender: 'user', content: "Actually yeah, I've been eyeing the MT-07. When can I come in?" },
      { id: 'msg4', sender: 'agent', content: "We've got openings Saturday morning or any weekday after 4pm. What works best?" },
      { id: 'msg5', sender: 'user', content: "Saturday morning is good." },
      { id: 'msg6', sender: 'agent', content: "You're booked for Saturday at 10am. We'll have the MT-07 gassed up and ready for a test ride." }
    ],
  ...
  },
  {
    ...
    description: 'After every sale and service visit, happy customers get a direct review link. Negative feedback gets intercepted before it goes public. Your reputation stays strong in the riding community.',
    stats: [
      { value: '4.8★', label: 'AVG RATING' },
    ],
    contactName: 'Jake',
    contactRole: 'Sold: 2025 Harley Iron 883',
    avatarInitials: 'Jake',
    messages: [
      { id: 'tag1', sender: 'system', content: { title: 'Purchase Verified' }, type: 'source_tag' },
      { id: 'msg1', sender: 'agent', content: "Hey Jake! Congrats on the new Iron 883 — hope you're loving it." },
      { id: 'msg2', sender: 'agent', content: "Quick question — how would you rate your experience with us at Thunder Road?" },
      { id: 'msg3', sender: 'user', content: "Honestly it was great. No pressure, fair deal, quick process." },
      { id: 'msg4', sender: 'agent', content: "That's awesome to hear! Would you mind sharing that on Google? It helps other riders find us." },
      { id: 'rev1', sender: 'agent', type: 'review', content: 'review_card' },
      { id: 'msg5', sender: 'user', content: "Done! Happy to help 🤙" }
    ],
...
const ChatBubble = ({ message, onPlay }: { message: Message; onPlay?: (id: string) => void }) => {
  ...
  return (
    <div className={`flex w-full mb-2 gap-2 items-end ${isAgent ? 'justify-end' : 'justify-start'}`}>
      {!isAgent && (
        <div className="w-6 h-6 rounded-full shrink-0 overflow-hidden border border-white/10 bg-[#1a1a1a]">
          <img src="/images/avatars/dealer-3.png" alt="" className="w-full h-full object-cover" />
        </div>
      )}
      <div
        className={`max-w-[78%] px-5 py-3 text-[15px] leading-snug relative tracking-normal font-medium shadow-md antialiased
        ${isAgent
...
export default function SeeItInActionPowersports() {
      ...
      <div className="container-wide relative z-10">
        ...
        <div className="mb-12 sm:mb-16 lg:mb-24 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#ff7404]/10 border border-[#ff7404]/20 text-[#ff7404] text-xs font-bold uppercase tracking-widest mb-6">
            ...
            Powersports Intelligence
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-[0.9] mb-6 sm:mb-8">
            Conversations<br />
            <span className="text-white/80">that sell units.</span>
          </h2>
          <p className="text-white/40 text-base sm:text-lg lg:text-2xl leading-relaxed">
            See how VisQuanta works across lead reactivation, inbound response, seasonal campaigns, review management, and service scheduling — shown through real powersports dealer conversations.
          </p>
        </div>
