...
export const DealerRaterLogo = ({ className }: { className?: string }) => (
    // Simplified DR logo representation for icon use
    <svg viewBox="0 0 24 24" className={className} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M2,12 A10,10 0 1,1 22,12 A10,10 0 1,1 2,12" fill="none" stroke="currentColor" strokeWidth="2" />
        <text x="12" y="16" fontSize="10" fontWeight="900" textAnchor="middle" fill="currentColor">DR</text>
    </svg>
);
