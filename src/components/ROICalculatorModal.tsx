                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="w-full md:w-1/3 bg-[#111] p-6 md:p-8 flex flex-col gap-6 border-b md:border-b-0 md:border-r border-white/5 relative">
                                <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent md:hidden" />

                                <div>
                                    <h3 className="text-xl font-bold text-white mb-1">Profit Calculator</h3>
                                    <p className="text-white/40 text-xs">Uncover your dealership's hidden revenue potential.</p>
                                </div>
                            ...
                            {/* Main Content Area */}
                            <div className="flex-1 p-6 md:p-10 relative flex flex-col justify-center overflow-y-auto">
                                <button
                                    onClick={onClose}
                                    ...
                                    {mode === 'reactivation' ? (
                                        ...
                                        >
                                            <div className="space-y-2">
                                                <h2 className="text-2xl font-bold text-white flex items-center gap-3">
                                                    <span className="w-2 h-8 rounded-full bg-[#ff7404]" />
                                                    Re-engage Lost Leads
                                                </h2>
                                                <p className="text-white/50 text-sm pl-5">Recover revenue from leads marked as 'Lost' or 'Dead'.</p>
                                            </div>

                                            <div className="space-y-6">
                                                <div className="space-y-4">
                                                    <div className="flex justify-between items-end">
                                                        <label className="text-xs font-bold text-white/60 uppercase tracking-wider">Cold Leads <span className="text-white/20 ml-1">(Last 12 Mo)</span></label>
                                                        <div className="text-xl font-bold text-white font-mono">{coldLeads.toLocaleString()}</div>
                                                    </div>
                                                ...
                                                <div className="space-y-4">
                                                    <div className="flex justify-between items-end">
                                                        <label className="text-xs font-bold text-white/60 uppercase tracking-wider">Avg Profit <span className="text-white/20 ml-1">(Front + Back)</span></label>
                                                        <div className="text-xl font-bold text-white font-mono">${reactivationGross.toLocaleString()}</div>
                                                    </div>
                                            ...
                                            <div className="bg-gradient-to-r from-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6 relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 w-40 h-40 bg-[#ff7404]/10 rounded-full blur-[60px]" />
                                                <div className="relative z-10 flex flex-col gap-1">
                                                    <div className="text-xs font-bold text-[#ff7404] uppercase tracking-widest mb-1">Estimated Annual Recovery</div>
                                                    <div className="text-5xl font-black text-white tracking-tight">{formatCurrency(reactivationRecovery)}</div>
                                                    <div className="text-white/40 text-xs mt-1">Based on a conservative 7% win-back calculation.</div>
                                                </div>
                                            </div>
                                        </motion.div>
                                    ) : (
                                        ...
                                        >
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-white/50 text-sm pl-5">Revenue gained by consistently responding in under 60 seconds.</p>
                                            </div>

                                            <div className="space-y-6">
                                                <div className="space-y-4">
                                                    <div className="flex justify-between items-end">
                                                        <label className="text-xs font-bold text-white/60 uppercase tracking-wider">Monthly Internet Leads</label>
                                                        <div className="text-xl font-bold text-white font-mono">{monthlyLeads.toLocaleString()}</div>
                                                    </div>
                                                ...
                                                <div className="space-y-4">
                                                    <div className="flex justify-between items-end">
                                                        <label className="text-xs font-bold text-white/60 uppercase tracking-wider">Avg Profit / Vehicle</label>
                                                        <div className="text-xl font-bold text-white font-mono">${speedGross.toLocaleString()}</div>
                                                    </div>
                                            ...
                                            <div className="bg-gradient-to-r from-[#1a1a1a] to-[#0a0a0a] border border-white/10 rounded-2xl p-6 relative overflow-hidden group">
                                                <div className="absolute top-0 right-0 w-40 h-40 bg-[#ff7404]/10 rounded-full blur-[60px]" />
                                                <div className="relative z-10 flex flex-col gap-1">
                                                    <div className="text-xs font-bold text-[#ff7404] uppercase tracking-widest mb-1">Additional Annual Revenue</div>
                                                    <div className="text-5xl font-black text-white tracking-tight">{formatCurrency(speedRecovery)}</div>
                                                    <div className="text-white/40 text-xs mt-1">Calculated from a 0.35% conversion lift on total volume.</div>
                                                </div>
                                            </div>
                                        </motion.div>
                                    )}
                                ...
                                <Link
                                    href="/book-demo"
                                    onClick={onClose}
                                    className={`mt-8 w-full flex items-center justify-center gap-2 font-bold py-4 rounded-xl transition-all shadow-lg group hover:scale-[1.01] ${mode === 'reactivation'
