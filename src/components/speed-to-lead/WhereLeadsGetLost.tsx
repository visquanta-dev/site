    ...
    return (
        <section className="py-32 bg-[#030303] relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute top-[20%] right-[-10%] w-[600px] h-[600px] bg-[#FF7404]/[0.02] rounded-full blur-[150px] pointer-events-none" />
            </div>
            ...
            <div className="container-wide relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight leading-[1.1]">
                        ...
                        <span className="text-[#FF7404]">Get Lost.</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {lossPoints.map((item, i) => (
                        <motion.div
                            ...
                            className="group relative bg-gradient-to-b from-[#0a0a0a] to-[#050505] border border-white/[0.06] rounded-2xl p-8 hover:border-[#FF7404]/30 transition-all duration-500 hover:shadow-[0_10px_40px_-10px_rgba(255,116,4,0.15)]"
                        >
                            {/* Hover glow */}
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex items-start justify-between mb-8">
                                    ...
                                    <div className="px-3 py-1.5 bg-[#FF7404]/[0.06] border border-[#FF7404]/10 rounded-full group-hover:bg-[#FF7404]/10 group-hover:border-[#FF7404]/20 transition-colors duration-500">
                                        <span className="text-[10px] font-bold text-[#FF7404]/80 uppercase tracking-widest">{item.indicator}</span>
                                    </div>
                                </div>
