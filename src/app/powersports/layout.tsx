...
export const metadata: Metadata = {
    ...
    description: 'Motorcycle, ATV, UTV, and marine dealers respond to leads in under 60 seconds, reactivate past shoppers, automate reviews, and run seasonal campaigns.',
