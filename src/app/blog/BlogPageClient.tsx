                            ...
                            {post.image ? (
                                <Image
                                    ...
                                    style={{
                                        ...
                                        filter: isImageOnly ? 'none' : 'grayscale(100%) contrast(1.1) brightness(0.6)'
                                    }}
                                    className={`${isImageOnly ? 'opacity-100' : 'opacity-50 group-hover:opacity-100 group-hover:scale-105'} transition-all duration-1000`}
                                />
                            ) : (
