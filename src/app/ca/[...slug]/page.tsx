...
const pageImports: Record<string, () => Promise<{ default: React.ComponentType }>> = {
    ...
    'subprocessors': () => import('@/app/subprocessors/page'),
    'compliance': () => import('@/app/compliance/page'),
...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
    ...
    const layoutMetadataRoutes: Record<string, () => Promise<any>> = {
        ...
        'subprocessors': () => import('@/app/subprocessors/layout'),
        'compliance': () => import('@/app/compliance/layout'),
