        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center max-w-md">
            <Button asChild className="group flex-1">
              <a href="https://calendly.com/droemer-visquanta/30-minute-meeting" target="_blank" rel="nofollow noopener noreferrer">
                Book a Demo
              </a>
            </Button>
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#F0F0F0] font-sans selection:bg-[#F97316]/30 relative overflow-hidden">
      ...
      <main className="relative z-20 mx-auto max-w-[1600px] px-4 md:px-8 py-10 lg:py-16">
        ...
        <div className="mt-32 relative z-20">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-[clamp(28px,3vw,38px)] font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-br from-white to-white/60">
              The Complete <span className="text-[#F97316] drop-shadow-[0_0_15px_rgba(249,115,22,0.4)]">Dealership Automation</span> Suite
            </h2>
            <p className="mx-auto max-w-2xl text-[15px] leading-relaxed text-white/50 font-light">
              Visquanta goes beyond reactivation and voice. Explore our other core modules designed to maximize your dealership's revenue.
            </p>
          </div>

          <div className="mx-auto grid max-w-6xl grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* Speed to Lead */}
            <div className="flex flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-sm transition-all hover:bg-white/[0.04] hover:border-white/10 group">
              <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#F97316]/20 to-transparent border border-[#F97316]/30 text-[#F97316] shadow-[0_0_20px_rgba(249,115,22,0.15)] group-hover:scale-110 transition-transform duration-300">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="mb-3 text-xl font-bold text-white tracking-tight">Speed to Lead</h3>
              <p className="text-sm leading-relaxed text-white/50 font-light flex-grow">
                Instantly engage new web leads within seconds of submission. Beat the competition to the conversation and dramatically increase your connect rate.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-sm transition-all hover:bg-white/[0.04] hover:border-white/10 group">
              ...
              <h3 className="mb-3 text-xl font-bold text-white tracking-tight">Reputation Management</h3>
              <p className="text-sm leading-relaxed text-white/50 font-light flex-grow">
                Automatically generate positive reviews from happy customers and intercept negative feedback before it hits Google. Build trust on autopilot.
              </p>
            </div>
            ...
            <div className="flex flex-col rounded-2xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-sm transition-all hover:bg-white/[0.04] hover:border-white/10 group">
              ...
              <h3 className="mb-3 text-xl font-bold text-white tracking-tight">Custom Campaigns</h3>
              <p className="text-sm leading-relaxed text-white/50 font-light flex-grow">
                Launch targeted AI outreach for lease renewals, equity mining, seasonal service specials, or specific inventory pushes.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-20 mx-auto max-w-[1600px] px-4 md:px-8 pb-32 flex flex-col items-center justify-center border-t border-white/5 pt-20 mt-16 text-center">
        ...
        <a 
          href="https://calendly.com/droemer-visquanta/30-minute-meeting" 
          target="_blank" 
