...
export default function CalculatorEmbed() {
    ...
    const initialMode = (searchParams.get('mode') === 'speedToLead' ? 'speedToLead' : 'reactivation') as CalculatorMode;
    const ctaUrl = searchParams.get('cta') || DEFAULT_CTA_URL;
    ...
    const reactivationRecovery = Math.round(coldLeads * 0.07 * reactivationGross);
    ...
    return (
        <div className="w-full max-w-4xl mx-auto bg-[#0a0a0a] border border-white/10 rounded-[2rem] shadow-2xl relative overflow-hidden flex flex-col md:flex-row md:h-[600px]">
            ...
            <div className="flex-1 p-4 md:p-10 relative flex flex-col justify-center overflow-y-auto">
                ...
                <a
                    ...
                    target="_top"
                    rel="noopener"
                    className="mt-5 md:mt-8 w-full flex items-center justify-center gap-2 font-bold py-3 md:py-4 rounded-xl transition-all shadow-lg group hover:scale-[1.01] bg-[#ff7404] text-black hover:bg-[#ff8524] shadow-[#ff7404]/20"
                >
                    Claim This Revenue
