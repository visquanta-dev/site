...
export const metadata: Metadata = {
    title: 'Automotive Speed to Lead Software | Respond in <60 Seconds | VisQuanta',
    description: 'Stop losing leads to slow response times. VisQuanta\'s AI BDC software automates lead response in under 60 seconds, 24/7. Validates, engages, and books appointments instantly.',
    ...
    openGraph: {
        title: 'Automotive Speed to Lead Software | Respond in <60 Seconds',
